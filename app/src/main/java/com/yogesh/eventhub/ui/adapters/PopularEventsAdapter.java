 ...
 */
public class PopularEventsAdapter extends RecyclerView.Adapter<EventItemHolder> implements StickyRecyclerHeadersAdapter<EventHeader> {
    private ArrayList<Events> events;
    private Context context;

    public PopularEventsAdapter(ArrayList<Events> events, Context context) {
        this.events = events;
